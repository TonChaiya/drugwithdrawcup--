...
<body class="app-page users-admin-page">

<?php include __DIR__ . '/includes/nav.php'; ?>

<main class="app-ui users-admin-main">
  <section class="users-admin-workspace">
    <div class="page-head">
      <div>
        <div class="eyebrow">ระบบเบิกยา CUP สันกำแพง</div>
        <h1>ผู้ใช้และสิทธิ์</h1>
        <div class="head-sub">จัดการบัญชีผู้ใช้ การอนุมัติ และขอบเขตที่คุณมีสิทธิ์ดูแล · ขอบเขต: <?= e($managementScopeSummary['label']) ?></div>
      </div>
      <div class="head-actions">
        <button type="button" class="btn primary" onclick="openUserModal('create')">+ เพิ่มผู้ใช้</button>
      </div>
    </div>
